# Progress Archive — August 2026

The run log up to the four most recent sessions, which stay in [`../PROGRESS.md`](../PROGRESS.md). Append-only history:
figures here were true when measured and are not restated to match later ones.
...
[`PRD.md`](../PRD.md) for the first time**, raised p@5 0.982 → 0.992, and costs 4.6× less. **The lane was the budget**;
the `max_tokens` tuning tried earlier was always going to be wasted effort.
